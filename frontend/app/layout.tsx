...
export const metadata: Metadata = {
  title: 'Satarkta - AI-Powered Fraud Detection Platform',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'Satarkta- AI-Powered Fraud Detection',
      },
    ],
  },
  twitter: {
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <head>
        <link rel="canonical" href="https://swift-owl-7.loca.lt" />
